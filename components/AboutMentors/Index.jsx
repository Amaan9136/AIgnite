    ...
    <section className="relative mb-28" id="about-mentors">
      <div className="relative">
        ...
        >
          ...
          {mentorsData.length==0?(<div>
                      <p className="text-center mt-10 font-semibold text-xl text-white">Mentors details will be updated soon. Stay tuned!</p>
                    </div>):mentorsData.map((mentor, index) => (
            <div
              key={index}
